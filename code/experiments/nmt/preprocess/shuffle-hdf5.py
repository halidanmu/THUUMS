...
for i, f in enumerate(infiles):
    infiles[i] = tables.openFile(f.name, f.mode)
    vlarrays_in.append(infiles[i].getNode('/phrases'))
    indices_in.append(infiles[i].getNode('/indices'))

for i, f in enumerate(outfiles):
    outfiles[i] = tables.openFile(f.name, f.mode)
