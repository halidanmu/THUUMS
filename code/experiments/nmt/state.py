def prototype_state():
    ...
    state['copy_model_freq'] = 10000
    state['copy_model_path'] = 'models/rnn_search_v300'
    ...
    # Specifies whether old model should be reloaded firstj
    state['reload'] = True
...
def prototype_encdec_state():
    ...
    state['target'] = ["data/bailing2011Q4/binarized_text.en.h5"]
    state['source'] = ["data/bailing2011Q4/binarized_text.zh.h5"]
    state['indx_word'] = "data/bailing2011Q4/ivocab.zh.pkl"
    state['indx_word_target'] = "data/bailing2011Q4/ivocab.en.pkl"
    state['word_indx'] = "data/bailing2011Q4/vocab.zh.pkl"
    state['word_indx_trgt'] = "data/bailing2011Q4/vocab.en.pkl"
